...
**Grafana.** We already ship logs to Grafana, but a dashboard is a fixed lens. I am limited to the panels and queries I have pre-configured. The moment I want to ask a slightly different question, like "show me the execution-time distribution bucketed by query shape, but only for the evening peak", I am fighting the tool instead of exploring the data.
